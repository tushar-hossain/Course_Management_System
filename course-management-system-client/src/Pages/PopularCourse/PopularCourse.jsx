...
const PopularCourse = () => {
  return (
    <section className="relative py-16 md:py-10 rounded-md bg-gradient-to-br from-white via-blue-50 to-purple-50 dark:from-gray-900 dark:via-blue-950 dark:to-purple-950 overflow-hidden">
