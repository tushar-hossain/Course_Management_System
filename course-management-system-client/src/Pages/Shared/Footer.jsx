...
const Footer = () => {
  ...
  const links = (
    <>
      <li>
        <NavLink to="/" className="hover:dark:text-violet-600">
          Home
        </NavLink>
      </li>
      <li>
        <NavLink to="/all-courses" className="hover:dark:text-violet-600">
          All Courses
        </NavLink>
      </li>
      {/*  */}
      {user && (
        <>
          <li>
            <NavLink to="/addCourse" className="hover:dark:text-violet-600">
              Add course
            </NavLink>
          </li>
          <li>
            <NavLink to="/manageCourse" className="hover:dark:text-violet-600">
              Manage Courses
            </NavLink>
          </li>
          <li>
      ...
      <li>
        <NavLink to="/instructor" className="hover:dark:text-violet-600">
          Courses Instructor
        </NavLink>
      </li>
    </>
      ...
      <footer className="py-6 mt-8 dark:bg-[#2f045a] bg-gray-100 dark:text-white">
        <div className="container px-6 mx-auto space-y-6 divide-y dark:divide-gray-600 md:space-y-12 divide-opacity-50">
          <div className="grid grid-cols-12">
            ...
            <div className="col-span-6 text-center md:text-left md:col-span-3 mb-5">
              <p className="pb-1 text-lg font-medium">Category</p>
              <ul>{links}</ul>
            </div>
            <div className="col-span-6 text-center md:text-left md:col-span-3">
              <p className="pb-1 text-lg font-medium">Social Link</p>
              <ul>
                <div className="flex justify-start pt-4 space-x-4 lg:pt-0 mt-3">
                  <a
                    rel="noopener noreferrer"
